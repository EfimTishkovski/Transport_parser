...
if __name__ == '__main__':
    arr = [{'ссылка' : 'время', 'ссылка новая' : '13-40'}, {'https://minsktrans.by/lookout_yard/Home/Index/minsk#/routes/trolleybus/4/stops/2417/1' : {'Понедельник': {'06': ('34',), '07': ('04', '40', '56'), '08': ('18', '47'), '09': ('10', '28', '48'), '10': ('14',), '15': ('35', '52'), '16': ('18', '37', '59'), '17': ('24', '47'), '18': ('11', '34', '54'), '19': ('21',)}, 'Вторник': {'06': ('34',), '07': ('04', '40', '56'), '08': ('18', '47'), '09': ('10', '28', '48'), '10': ('14',), '15': ('35', '52'), '16': ('18', '37', '59'), '17': ('24', '47'), '18': ('11', '34', '54'), '19': ('21',)}, 'Среда': {'06': ('34',), '07': ('04', '40', '56'), '08': ('18', '47'), '09': ('10', '28', '48'), '10': ('14',), '15': ('35', '52'), '16': ('18', '37', '59'), '17': ('24', '47'), '18': ('11', '34', '54'), '19': ('21',)}, 'Четверг': {'06': ('34',), '07': ('04', '40', '56'), '08': ('18', '47'), '09': ('10', '28', '48'), '10': ('14',), '15': ('35', '52'), '16': ('18', '37', '59'), '17': ('24', '47'), '18': ('11', '34', '54'), '19': ('21',)}, 'Пятница': {'06': ('34',), '07': ('04', '40', '56'), '08': ('18', '47'), '09': ('10', '28', '48'), '10': ('14',), '15': ('35', '52'), '16': ('18', '37', '59'), '17': ('24', '47'), '18': ('11', '34', '54'), '19': ('21',)}, 'Суббота': 'В этот день не ходит', 'Воскресенье': 'В этот день не ходит'}}]

    for line in arr:
        link =list(line.keys())
        times = list(line.values())
        print(link, times)
